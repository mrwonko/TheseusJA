...
extern	qboolean	Q3_TaskIDPending( sharedEntityMapper_t<Ctx> *ent, taskID_t taskType );
template <ModuleContext Ctx>
extern	void		Q3_TaskIDComplete( sharedEntityMapper_t<Ctx> *ent, taskID_t taskType );

...
namespace Q
{
	...
	namespace detail {
		...
		public:
			...
			template <typename U = T, typename std::enable_if<std::is_copy_assignable<U>::value, int>::type = 0>
			...
			template <typename U = T, typename std::enable_if<std::is_move_assignable<U>::value, int>::type = 0>
	...
	*/
	...
	class LimitedVector< T, maximum, typename std::enable_if<std::is_trivially_destructible< T >::value>::type > : public detail::LimitedVectorBase< T, maximum, LimitedVector< T, maximum > >
	{
		using detail::LimitedVectorBase< T, maximum, LimitedVector< T, maximum > >::LimitedVectorBase;
		// no destructor!
	};
